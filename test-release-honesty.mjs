...
assert.ok(chartHtml.includes('ap-chart-v835.css?v=865'));
assert.ok(chartHtml.includes('ap-load-interpretations.js?v=865') && chartHtml.includes('chart-page.js?v=865'));
assert.ok(chartHtml.includes('reading-format.js?v=865') && chartHtml.includes('chart-render.js?v=865'));
