...
assert.ok(chartHtml.includes('ap-chart-v835.css?v=872'));
assert.ok(chartHtml.includes('ap-load-interpretations.js?v=872') && chartHtml.includes('chart-page.js?v=872'));
assert.ok(chartHtml.includes('reading-format.js?v=872') && chartHtml.includes('chart-render.js?v=872'));
