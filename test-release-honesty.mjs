...
assert.ok(chartHtml.includes('ap-chart-v835.css?v=860'));
assert.ok(chartHtml.includes('ap-load-interpretations.js?v=860') && chartHtml.includes('chart-page.js?v=860'));
assert.ok(chartHtml.includes('reading-format.js?v=860') && chartHtml.includes('chart-render.js?v=860'));
