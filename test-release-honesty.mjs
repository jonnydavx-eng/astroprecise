...
assert.ok(chartHtml.includes('ap-chart-v835.css?v=871'));
assert.ok(chartHtml.includes('ap-load-interpretations.js?v=871') && chartHtml.includes('chart-page.js?v=871'));
assert.ok(chartHtml.includes('reading-format.js?v=871') && chartHtml.includes('chart-render.js?v=871'));
