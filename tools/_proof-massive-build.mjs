...
ok(/ap-eclipse-live-v834\.js\?v=857/.test(eclipse), 'eclipse loads the dedicated v842 3D instrument');
...
ok(versionMatch && versionMatch[1] === 'ap-v857', 'SW release tip ' + (versionMatch && versionMatch[1]));
