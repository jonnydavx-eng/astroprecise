...
ok(/js\/ap-nav-model\.js\?v=858/.test(index) && !/ap-nav-model-v834/.test(index), 'index uses the one canonical navigation model');
...
ok(/ap-eclipse-live-v834\.js\?v=858/.test(eclipse), 'eclipse loads the dedicated 3D instrument');
...
ok(versionMatch && versionMatch[1] === 'ap-v858', 'SW release tip ' + (versionMatch && versionMatch[1]));
