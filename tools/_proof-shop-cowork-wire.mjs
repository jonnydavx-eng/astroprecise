/**
 * Proof: v836 authored shop, Eclipse Passport, availability list and truthful no-checkout state.
 */
...
if (!/const V\s*=\s*["']ap-v836["']/.test(sw)) fails.push('SW tip is not exactly v836');
