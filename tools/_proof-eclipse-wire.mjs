...
const fails = [];
if (!/ap-eclipse-live-v834\.js\?v=857/.test(eclipseHtml)) fails.push('eclipse missing dedicated 3D module');
...
if (!/ap-eclipse-contact-v835\.js\?v=857/.test(eclipseHtml)) fails.push('eclipse missing contact controller');
