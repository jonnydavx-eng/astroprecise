...
const fails = [];
if (!/ap-eclipse-live-v834\.js\?v=853/.test(eclipseHtml)) fails.push('eclipse missing dedicated 3D module');
...
if (!/ap-eclipse-contact-v835\.js\?v=853/.test(eclipseHtml)) fails.push('eclipse missing contact controller');
...
if (!/const V\s*=\s*["']ap-v853["']/.test(sw)) fails.push('SW tip is not exactly v852');
