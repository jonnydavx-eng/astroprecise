...
if (!/ap-eclipse-live-v834\.js\?v=899/.test(html)) fails.push('dedicated simulation is not pinned to v899');
if (!/ap-eclipse-contact-v835\.js\?v=899/.test(html)) fails.push('contact controller is not pinned to v899');
