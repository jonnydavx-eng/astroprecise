...
const PRECACHE = [
  ...
  './img/textures/earth_clouds_1024.png',
  './img/textures/earth_lights_2048.png',
  './img/textures/jupitermap.jpg',
  './img/textures/marsmap1k.jpg',
  './img/textures/mercurymap.jpg',
  './img/textures/moon_1024.jpg',
  './img/textures/neptunemap.jpg',
  './img/textures/saturnmap.jpg',
  './img/textures/uranusmap.jpg',
  './img/textures/venusmap.jpg',
...
self.addEventListener('install', e => {
  e.waitUntil(
    caches.open(V).then(c => {
      ...
      return c.addAll(installCore).then(() => Promise.allSettled(OPTIONAL.map(u =>
