import { buildEclipseReading5 } from './eclipse-reading.js?v=905';
import { loadEditionContext, mountEclipseEdition } from './ap-eclipse-edition-v841.js?v=905';
...
async function init() {
  ...
  const [engine, templates] = await Promise.all([
    waitForEphemeris(),
    fetch('js/reading-templates.json?v=905').then((response) => {
