...
(function () {
  ...
  function cardHtml(c, isActive) {
    ...
    var activeBadge = isActive
      ? '<a class="mc-card__active" href="transits.html" title="Powers your personal transit reading">Today’s transits →</a>'
      : '';
    return '' +
    ...
    return '' +
      '<div class="app-empty-state" data-mc-state="empty">' +
        ...
        '<div class="app-empty-state__actions">' +
          ...
          '<a class="btn btn--outline btn--lg" href="tonight.html">Tonight’s sky</a>' +
        '</div>' +
      '</div>';
  }
