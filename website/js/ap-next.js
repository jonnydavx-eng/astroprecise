(function(){
  ...
  function boot(){
    ...
    if(!document.querySelector('link[href*="ap-next.css"]')){const l=document.createElement('link');l.rel='stylesheet';l.href=url('css/ap-next.css?v=913');document.head.append(l);}
