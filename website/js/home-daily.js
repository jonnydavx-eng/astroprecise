...
(function () {
  ...
  function injectCss() {
    ...
    var css =
      ...
      '.home-daily__sign{display:inline-flex;align-items:center;gap:.4rem;padding:.42rem .7rem;border:1px solid rgba(139,169,255,.3);border-radius:999px;background:rgba(16,29,48,.72);color:var(--ap-paper,#EEF4FA);font:600 .82rem/1 var(--font-ui,Inter),sans-serif;cursor:pointer;transition:border-color .2s,background .2s,transform .15s}' +
      '.home-daily__sign:hover{border-color:rgba(165,188,255,.78);transform:translateY(-1px)}' +
      '.home-daily__sign[aria-pressed="true"]{border-color:var(--ap-ion,#8BA9FF);background:rgba(139,169,255,.16);box-shadow:0 0 0 1px rgba(165,188,255,.42) inset}' +
      '.home-daily__glyph{font-family:"AstroGlyph",serif;font-variant-emoji:text;font-size:1.05em;line-height:1;color:var(--ap-ion,#8BA9FF)}' +
      '.home-daily__sign--fire .home-daily__glyph{color:var(--ap-danger,#FF8EA8)}.home-daily__sign--earth .home-daily__glyph{color:var(--ap-proof,#6FD0B3)}' +
      '.home-daily__sign--air .home-daily__glyph{color:var(--ap-paper-bright,#C9D6E3)}.home-daily__sign--water .home-daily__glyph{color:var(--ap-cyan,#79C7F2)}' +
      '.home-daily__card{max-width:640px;margin:0 auto;background:rgba(16,29,48,.76);border:1px solid rgba(139,169,255,.24);border-radius:16px;padding:clamp(1.2rem,3vw,2rem);text-align:left}' +
      '.home-daily__eyebrow{font:600 .72rem/1.3 var(--font-mono,monospace);letter-spacing:.14em;text-transform:uppercase;color:var(--ap-ion,#8BA9FF);margin:0 0 .5rem}' +
      '.home-daily__title{font:600 1.5rem/1.2 var(--font-serif,serif);color:var(--ap-paper,#EEF4FA);margin:0 0 .35rem}' +
      '.home-daily__overview{color:rgba(201,214,227,.94);line-height:1.65;margin:.4rem 0 1rem}' +
      '.home-daily__transits{list-style:none;margin:0 0 1rem;padding:0;display:flex;flex-direction:column;gap:.45rem}' +
      '.home-daily__transit{display:flex;gap:.55rem;align-items:baseline;font-size:.86rem;color:rgba(201,214,227,.86);line-height:1.5}' +
      '.home-daily__transit b{color:var(--ap-ion,#8BA9FF);font-weight:600;white-space:nowrap}' +
      '.home-daily__gauge{height:8px;border-radius:6px;background:rgba(147,168,191,.12);overflow:hidden;margin:.2rem 0 .3rem}' +
      '.home-daily__gauge span{display:block;height:100%;background:linear-gradient(90deg,var(--ap-violet,#A897FF),var(--ap-ion,#8BA9FF),var(--ap-cyan,#79C7F2))}' +
      '.home-daily__gauge-row{display:flex;justify-content:space-between;font:600 .68rem/1 var(--font-mono,monospace);letter-spacing:.1em;text-transform:uppercase;color:var(--ap-ion,#8BA9FF);margin-bottom:1rem}' +
      '.home-daily__facts{font-size:.76rem;color:rgba(147,168,191,.82);line-height:1.55;margin:.2rem 0 1rem}' +
      '.home-daily__note{font-size:.78rem;color:rgba(147,168,191,.9);line-height:1.55;border-left:2px solid rgba(139,169,255,.48);padding-left:.7rem;margin:0 0 1.1rem}' +
      '.home-daily__cta-row{display:flex;flex-wrap:wrap;gap:.6rem;align-items:center}' +
      '.home-daily__return{font-size:.74rem;color:rgba(147,168,191,.74);margin:1rem 0 0;font-style:italic}' +
      '.home-daily__save-hint{font-size:.76rem;color:rgba(165,188,255,.88);line-height:1.5;margin:.8rem 0 0}' +
      '.home-daily__sky-btn{display:inline-flex;align-items:center;gap:.45em;margin:0 0 1rem;padding:.5rem .9rem;border:1px solid rgba(139,169,255,.48);border-radius:10px;background:rgba(16,29,48,.72);color:var(--ap-ion,#8BA9FF);font:600 .82rem/1 var(--font-ui,Inter),sans-serif;cursor:pointer;transition:border-color .2s,background .2s,transform .15s}' +
      '.home-daily__sky-btn:hover{border-color:var(--ap-ion-hover,#A5BCFF);background:rgba(139,169,255,.16);transform:translateY(-1px)}' +
      '.home-daily__sky-btn span{color:var(--ap-violet,#A897FF)}' +
      '.home-daily__save-view{position:fixed;left:50%;bottom:1.1rem;transform:translateX(-50%);z-index:80;margin:0;background:rgba(10,20,36,.94);box-shadow:0 6px 18px rgba(0,0,0,.45)}' +
      '.home-daily__save-view:hover{transform:translateX(-50%) translateY(-1px)}' +
      '.home-daily__prompt{color:rgba(147,168,191,.9);text-align:center;margin:.2rem 0 0;font-size:.9rem}';
