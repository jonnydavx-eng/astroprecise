...
(function () {
  ...
  function injectStyle() {
    ...
    var css =
      ...
      'background:linear-gradient(90deg,var(--gold,#C2A05E),var(--brass-shadow,#8C7544));opacity:0.8;}' +
      ...
      'text-transform:uppercase;color:var(--gold,#C2A05E);margin:0 0 0.4rem;}' +
      ...
      'background:rgba(194, 160, 94,0.1);border:1px solid rgba(194, 160, 94,0.28);border-radius:999px;' +
      ...
      '.dt-aspect__rel{font-size:0.95rem;color:var(--gold,#C2A05E);width:1.4rem;text-align:center;flex-shrink:0;}' +
      ...
      '.dt-aspect__orb{font-size:0.68rem;color:var(--gold,#C2A05E);white-space:nowrap;flex-shrink:0;opacity:0.85;}' +
      ...
      'color:var(--gold-light,#E8C872);background:rgba(194, 160, 94,0.10);' +
      'border:1px solid rgba(194, 160, 94,0.28);border-radius:999px;padding:0.25rem 0.7rem;}' +
      ...
      '.dt-tease a{color:var(--gold,#C2A05E);text-decoration:none;border-bottom:1px solid rgba(194, 160, 94,0.4);' +
      'transition:border-color 0.2s;}' +
      '.dt-tease a:hover{border-bottom-color:var(--gold,#C2A05E);}' +
