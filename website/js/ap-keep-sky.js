 ...
 *
 * Chart birth-hour path: Keep → void-orrery.captureStill({mode:'birth-hour',jd})
...
(function () {
  ...
  /* Surface A still: SCHEMATIC honesty + caption on the file. No live badge. */
  function stampSurfaceA(canvas, context) {
    ...
    var body = context
      ? caption(context)
      : 'Observatory still · current view · not a live badge.';
