...
window.APDailyBridge = (function () {
  ...
  function mountHoroscopeBridge() {
    ...
    if (!chart) {
      host.innerHTML =
        '<div class="ap-sky-bridge ap-reveal-smooth">' +
          ...
          '<p style="font-size:0.88rem;color:var(--ap-text-secondary,#BEB298);margin:0;line-height:1.6;">' +
    ...
    host.innerHTML =
      '<div class="ap-sky-bridge ap-reveal-smooth ap-glow-hover">' +
        ...
        '</div>' +
        '<p style="font-size:0.84rem;color:var(--ap-text-secondary,#BEB298);margin:0;line-height:1.55;">' +
  ...
  function enhanceDailyTransitCard() {
    ...
    footer.style.cssText = 'margin-top:1.25rem;padding-top:1rem;border-top:1px solid rgba(194,160,94,0.12);display:flex;flex-wrap:wrap;gap:0.5rem;';
    footer.innerHTML =
