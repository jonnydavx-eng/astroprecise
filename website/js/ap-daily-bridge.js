...
window.APDailyBridge = (function () {
  ...
  function mountHoroscopeBridge() {
    ...
    if (!chart) {
      host.innerHTML =
        '<div class="ap-sky-bridge ap-reveal-smooth">' +
          ...
          '<p style="font-size:0.88rem;color:var(--ap-text-secondary,#93A8BF);margin:0;line-height:1.6;">' +
    ...
    host.innerHTML =
      '<div class="ap-sky-bridge ap-reveal-smooth ap-glow-hover">' +
        ...
        '</div>' +
        '<p style="font-size:0.84rem;color:var(--ap-text-secondary,#93A8BF);margin:0;line-height:1.55;">' +
  ...
  function enhanceDailyTransitCard() {
    ...
    footer.innerHTML =
      '<a href="observatory.html" class="btn btn--outline btn--sm">Observatory</a>' +
