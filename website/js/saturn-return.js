...
(function () {
  ...
  function pdfDoc(data, idx, name) {
    ...
    var css =
      ...
      '.page::before{content:"";position:absolute;inset:8mm;border:1px solid rgba(168,176,188,.42);pointer-events:none}' +
      '.page::after{content:"";position:absolute;inset:9.4mm;border:1px solid rgba(168,176,188,.15);pointer-events:none}' +
      '.seal{text-align:center;color:#A8B0BC;font-size:20pt;margin:0 0 6pt}' +
      ...
      'h1{font-family:"Cinzel",serif;font-size:26pt;line-height:1.12;text-align:center;color:#E8EBF0;margin:0 0 4pt;font-weight:700}' +
      '.glyph{text-align:center;font-size:30pt;color:#A8B0BC;margin:6pt 0 2pt}' +
      ...
      'strong{color:#E8EBF0;font-weight:600}em{color:#A8B0BC}' +
      '.sat-orn{display:flex;align-items:center;gap:10pt;color:#A8B0BC;margin:15pt 0}' +
      '.sat-orn::before,.sat-orn::after{content:"";flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(168,176,188,.5),transparent)}' +
      '.sat-orn span{font-size:8.5pt;letter-spacing:.34em}' +
      '.sat-list{list-style:none;padding:0;margin:6pt 0}.sat-list li{font-size:10.5pt;padding:4pt 0;border-bottom:1px solid rgba(168,176,188,.14)}' +
