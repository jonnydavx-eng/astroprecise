...
<head>
  ...
  <script src="js/defer-page-css.js?v=907" defer></script>
  <script src="js/ap-sign-defer-boot.js?v=907" defer></script>
...
${footerBlockHtml()}
  ...
  <script src="js/content-service.js?v=907"></script>
  <script src="js/sign-daily.js?v=907"></script>
  <script src="js/ap-zodiac-constants.js?v=907"></script>
  <script src="js/sign-page-boot.js?v=907"></script>
  <script src="js/ap-page-boot.js?v=907" defer></script>
  <script src="js/ap-footer-inject.js?v=907" defer></script>
</body>
</html>
`;
}
