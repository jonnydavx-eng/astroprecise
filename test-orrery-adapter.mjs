...
if (!/js\/void-orrery-adapter\.js\?v=869/.test(indexHtml)) fail('Home missing v869 adapter query');
if (!/<link[^>]+rel="modulepreload"[^>]+href="js\/orrery-webgl\.js\?v=869"/.test(indexHtml)) {
  fail('Home missing exact v869 WebGL modulepreload');
}
...
for (const ref of [
  'css/ap-living-sky-v834.css?v=869',
    'js/ap-observatory-v834.js?v=869',
    'js/ap-nav-model.js?v=869',
]) {
...
if (!sw.includes('const V = "ap-v869"')) fail('service worker release identity is not ap-v869');
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=869',
    'css/ap-eclipse-live-v834.css?v=869',
]) {
