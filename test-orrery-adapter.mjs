...
for (const ref of [
  'css/ap-living-sky-v834.css?v=847',
    'js/ap-observatory-v834.js?v=847',
    'js/ap-nav-model.js?v=847',
]) {
...
if (!sw.includes('const V = "ap-v847"')) fail('service worker release identity is not ap-v847');
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=847',
    'css/ap-eclipse-live-v834.css?v=847',
]) {
