...
if (!/js\/void-orrery-adapter\.js\?v=871/.test(indexHtml)) fail('Home missing v871 adapter query');
if (!/<link[^>]+rel="modulepreload"[^>]+href="js\/orrery-webgl\.js\?v=871"/.test(indexHtml)) {
  fail('Home missing exact v871 WebGL modulepreload');
}
...
for (const ref of [
  'css/ap-living-sky-v834.css?v=871',
    'js/ap-observatory-v834.js?v=871',
    'js/ap-nav-model.js?v=871',
]) {
...
if (!sw.includes('const V = "ap-v871"')) fail('service worker release identity is not ap-v871');
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=871',
    'css/ap-eclipse-live-v834.css?v=871',
]) {
