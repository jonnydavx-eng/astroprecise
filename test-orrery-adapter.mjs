...
for (const ref of [
  'css/ap-living-sky-v834.css?v=846',
    'js/ap-observatory-v834.js?v=846',
    'js/ap-nav-model.js?v=846',
]) {
...
if (!sw.includes('const V = "ap-v846"')) fail('service worker release identity is not ap-v846');
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=846',
    'css/ap-eclipse-live-v834.css?v=846',
]) {
