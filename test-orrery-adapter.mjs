...
if (!/js\/void-orrery-adapter\.js\?v=870/.test(indexHtml)) fail('Home missing v870 adapter query');
if (!/<link[^>]+rel="modulepreload"[^>]+href="js\/orrery-webgl\.js\?v=870"/.test(indexHtml)) {
  fail('Home missing exact v870 WebGL modulepreload');
}
...
for (const ref of [
  'css/ap-living-sky-v834.css?v=870',
    'js/ap-observatory-v834.js?v=870',
    'js/ap-nav-model.js?v=870',
]) {
...
if (!sw.includes('const V = "ap-v870"')) fail('service worker release identity is not ap-v870');
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=870',
    'css/ap-eclipse-live-v834.css?v=870',
]) {
