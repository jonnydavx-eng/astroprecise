...
if (!/js\/void-orrery-adapter\.js\?v=872/.test(indexHtml)) fail('Home missing v872 adapter query');
if (!/<link[^>]+rel="modulepreload"[^>]+href="js\/orrery-webgl\.js\?v=872"/.test(indexHtml)) {
  fail('Home missing exact v872 WebGL modulepreload');
}
...
for (const ref of [
  'css/ap-living-sky-v834.css?v=872',
    'js/ap-observatory-v834.js?v=872',
    'js/ap-nav-model.js?v=872',
]) {
...
for (const ref of [
  'js/ap-eclipse-live-v834.js?v=872',
    'css/ap-eclipse-live-v834.css?v=872',
]) {
