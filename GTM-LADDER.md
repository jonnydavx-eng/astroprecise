...
"every number is real and free" voice, so it is deliberately dropped. (A `£2.49/mo` Cosmic Weather
letter is sketched in `GROWTH.md` as a Phase-2 *maybe* (**£2.49/mo**); it is **not** part of this launch ladder.)
...
| 1 | **Natal Chart Poster — digital PDF** (print-at-home, A3/A2) | **£6** | the Pinterest/IG magnet; sells as a hosted PDF today | `posterUrl` |
| 2 | **The Deep Reading** (PDF, ~6–10pp, the Desktop sample) | **£12** | the hero; impulse-priced vs Etsy noise | `deepReadingUrl` / `reportUrl` |
| 3 | **Personalized POD merch** — natal poster print, sky tee, chart mug (from *their* chart) | **£9–22** | "wear your sky" — physical print-on-demand, fulfilled per order (see `POD-PLAYBOOK.md`) | `posterUrl` (store) |
| 4 | **Reading + Poster bundle** | **£16** | the anchor: makes £12 + £6 look like a deal | `deepReadingUrl` (bundle product) |
| 5 | **Gift a Reading** | **£15** | gifting carries a premium; Valentine's/birthday/anniversary seasonal | `giftUrl` |
| 6 | **Bespoke natal-art commission** (one-of-one, hand-finished chart artwork) | **£65+** | scarcity at the top; cap at ~5/month to keep the promise true | `posterUrl` (commission listing) or a dedicated hosted product |
...
|---|---|---|
| Natal poster — physical print A3/A2 | **£18–22** | Gelato/Printful; the digital PDF (£6) is the taster → upsell |
| Sky tee (your planets, printed) | **£15–18** | Bella+Canvas-class blank, DTG |
| Chart mug ("your sky, your mug") | **£8–12** | low entry POD impulse buy |
| Star-map / constellation framed print | **£20–24** | back-catalogue companion to the natal poster |

## Why this shape works
- **A free doorway, then a low-friction first paid step.** Free chart → £6 digital poster is a tiny leap;
  it converts curiosity into a first transaction and a saved email.
- **One hero, one anchor.** The £12 Deep Reading is the thing we actually sell; the £16 bundle anchors it
  so £12 reads as restraint, not the ceiling.
...
2. **Open the hero + first paid step.** Create the £12 Deep Reading and £6 poster as Gumroad products;
