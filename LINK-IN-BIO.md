...
✷ **[GET THE DEEP READING — £24]**
→ Hosted product (Gumroad), the `deepReadingUrl` target
_A beautiful 6–10 page reading of your exact chart. Or the print-at-home Natal Poster, £12._
...
1. **Nothing fake.** Only list links that work. The £24 reading / shop links go live **only** once the
