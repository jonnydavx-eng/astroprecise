...
**Tip:** ap-v902 · **Scope:** website/ only · **Owner law:** honesty over spectacle, one WebGL context per page.
...
**Stage 4** = deploy / ship-harden / owner eye-check (not new emitters). Current candidate delivery tip is ap-v902; public production remains ap-v895 until authorised release.
