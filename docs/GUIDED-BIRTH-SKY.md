...
The v912 service worker installs the compact guided journey, not the full 3D texture library. Updates wait for the user's explicit update action when an older worker controls the page. Checkout remains closed.
