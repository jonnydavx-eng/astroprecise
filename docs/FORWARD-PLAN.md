# FORWARD PLAN — AstroPrecise · 2026-07-13
...
**★ Ultimate continuous plan (all seat research synthesized):** `docs/OBSERVATORY-CORE-ULTIMATE-MASTER-PLAN-2026-07-13.md`  
**Team lock:** `docs/OBSERVATORY-CORE-TEAM-CONTINUITY.md`
...
- Model surface contract A/B/C
- Personal Sky Moment Stages 0–3 code + Stage 4 deploy (ap-v721 LIVE)
- Ship-harden: SW bypass, test:ui, CI sky-bridge, Explore toggle, pointer-events
- Homepage-as-model / scale ladder / observatory look-through
- Deploy path: website/** → main → Actions Pages (never force-push)

## Open — owner only
- Live hard-refresh: confirm SW ap-v721
- Phone Personal Sky Moment pass
- Checkout URLs when selling (deepReadingUrl / AP_MON)
- OrbitLab free-explore / galaxy port only if re-asked
...
## Definition of done — milestone “Personal Sky Moment v1 closed”
- Owner: incognito SW ap-v721 + phone cast→explore→focus→share path
- Contract honesty holds (no LIVE on stills)
- npm test + npm run test:ui green
- Live SW matches STATUS tip
- Commerce still dormant-honest unless URLs pasted
